...
Scenario: Remember Last Trip
  ...
  Then I should see the route "From Parnassus Campus"
  And I should see the route "To Mission Bay Campus"
  ...
  And I visit the Shuttle Trip Planner page
  Then I should see the route "From Mt. Zion"
...
Scenario: Remember Reversed Trip
  ...
  Then I should see "Suggested Routes"
  And I visit the Shuttle Trip Planner page
  Then I should see the route "From 654 Minnesota"
  And I should see the route "To Mt. Zion"
...
Scenario: Optimal Route From Mission Bay To Buchanan Dental Center
  ...
  And I select "To Buchanan Dental Center"
