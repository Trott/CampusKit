ucsf.shuttle = (function () {
    ...
    me.renderSchedule = function(response) {
        ...
        if (target && target.innerHTML) {
            var template = new Hogan.Template(
                function(c,p,i){var _=this;_.b(i=i||"");_.b("<p>");if(_.s(_.f("times",c,p,1),c,p,0,13,34,"{{ }}")){_.rs(c,p,function(c,p,_){_.b(_.v(_.f("formattedTime",c,p,0)));_.b("<br>");});c.pop();}if(!_.s(_.f("times",c,p,1),c,p,1,0,0,"")){_.b("No shuttle times found for selected date.");}_.b("</p>");return _.fl();}
            );
            resultsElement.innerHTML = template.render(response);
