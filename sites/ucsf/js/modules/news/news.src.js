// Because this script uses Modernizr, it requires campuskit.js to be loaded first.
// So news.js and campuskit.js should be loaded with "defer" only (and not "async")
// on pages that have news.js, so that campuskit.js can be loaded first.
