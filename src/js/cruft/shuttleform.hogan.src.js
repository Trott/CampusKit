...
var template = '<form id="ucsf_shuttle_trip_form" action="/shuttle/planner/">';
    ...
    template += '<p>Content could not be loaded.</p>';
    template += '{{/stops}}';
    template += '<fieldset name="datetime">';
    template += '<legend>';
    template += '<select class="compact" name="when" onchange="form.time.disabled = form.date.disabled = value==\'now\'">';
    ...
    template += '</select>';
    template += '</legend>';
    template += '<select disabled class="compact" name="time">';
    ...
    template += '</select>';
    template += '<select disabled class="compact" name="date">';
